<%@ Page Title="Логване" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Login.aspx.cs" Inherits="Account_Login" Async="true" %>
    ...
    <div class="row">
        <div class="col-md-8">
            <section id="loginForm">
                    ...
                    <div class="form-group">
                        <div class="col-md-offset-2 col-md-10">
                            <div class="checkbox">
                                ...
                                <asp:Label ID="Label3" runat="server" AssociatedControlID="RememberMe">Запомни ме?</asp:Label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                ...
                <p>
                    <asp:HyperLink runat="server" ID="RegisterHyperLink" ViewStateMode="Disabled">Регистрирай се</asp:HyperLink>
                    ако нямаш акаунт.
                </p>
            </section>
        </div>
